...
public class Report extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("  Quotation Details");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        dialog.setSelectedFile(new File("Quotation Report.pdf"));
        ...
        if (dialogResult==JFileChooser.APPROVE_OPTION){
            ...
            try {
                ...
                myDocument.add(new Paragraph("Project List",FontFactory.getFont(FontFactory.TIMES_BOLD,20,Font.BOLD )));
                myDocument.add(new Paragraph(new Date().toString()));
                myDocument.add(new Paragraph("-------------------------------------------------------------------------------------------"));
                
                table.addCell(new PdfPCell(new Paragraph("Qid",FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.BOLD))));
                table.addCell(new PdfPCell(new Paragraph("CompanyName",FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.BOLD))));
                ...
                table.addCell(new PdfPCell(new Paragraph("E_mail",FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.BOLD))));
                table.addCell(new PdfPCell(new Paragraph("Delivery_No",FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.BOLD))));
                ...
                table.addCell(new PdfPCell(new Paragraph("UnitPrice",FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.BOLD))));
                table.addCell(new PdfPCell(new Paragraph("TotalPrice",FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.BOLD))));
