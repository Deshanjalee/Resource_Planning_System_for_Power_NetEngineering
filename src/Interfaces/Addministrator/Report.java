...
public class Report extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("  Solar Account Details");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        dialog.setSelectedFile(new File("Solar Expenses Report.pdf"));
        ...
        if (dialogResult==JFileChooser.APPROVE_OPTION){
            ...
            try {
                ...
                String sql ="select * from sloarexpenses ";
                ...
                float[] columnWidths = new float[] {20,20,20,20,20,20};
                table.setWidths(columnWidths);
                ...
                myDocument.add(new Paragraph("Solar Expence List",FontFactory.getFont(FontFactory.TIMES_BOLD,20,Font.BOLD )));
                myDocument.add(new Paragraph(new Date().toString()));
                myDocument.add(new Paragraph("-------------------------------------------------------------------------------------------"));
                
                table.addCell(new PdfPCell(new Paragraph("expId",FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.BOLD))));
                ...
                table.addCell(new PdfPCell(new Paragraph("expense",FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.BOLD))));
                table.addCell(new PdfPCell(new Paragraph("amount",FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.BOLD))));
                table.addCell(new PdfPCell(new Paragraph("notes",FontFactory.getFont(FontFactory.TIMES_ROMAN,9,Font.BOLD))));
